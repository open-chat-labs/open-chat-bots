...
export function subscriptionEventType(domain: ChatSubscriptionType): ChatEventType {
    switch (domain) {
        case "message":
            return "Message";
        case "membership_update":
            return "MembershipUpdate";
        case "chat_details_update":
            return "ChatDetailsUpdate";
    }
}
...
export function unitResult(api: ApiUnitResult): UnitResult {
    if (api === "Success") {
        return { kind: "success" };
    } else {
        return {
