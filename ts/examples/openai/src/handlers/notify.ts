import { BotClient, BotEvent, handleNotification } from "@open-ic/openchat-botclient-ts";
...
async function handleTextMessage(client: BotClient, message: ModeratableContent) {
